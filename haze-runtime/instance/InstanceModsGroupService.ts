import { InstanceModsGroupService as IInstanceModsGroupService, InstanceModsGroupState, InstanceGroupStateKey, InstanceModsGroupServiceKey, ModGroupRules, SharedState, ModGroupData } from '@haze/runtime-api'
