import { type AddInstanceServerOptions, InstanceServerInfoServiceKey, type RemoveInstanceServerOptions, ServerInfoState, type UpdateInstanceServerOptions, getServerInfoKey, type InstanceServerInfoService as IInstanceServerInfoService, SharedState } from '@haze/runtime-api'
import { readServerInfo, writeServerInfo, ServerInfo } from '@haze/game-data'
