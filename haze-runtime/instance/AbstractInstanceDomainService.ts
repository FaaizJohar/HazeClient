import { InstallMarketOptionWithInstance, LockKey, ResourceState, SharedState, UpdateInstanceResourcesOptions, getInstanceModStateKey } from '@haze/runtime-api'
import { ensureDir, mkdir, stat, unlink } from 'fs-extra'
import { basename, join } from 'path'
import { LauncherApp } from '~/app'
import { InstanceService } from '~/instance'
import { kMarketProvider } from '~/market'
import { Resource, ResourceDomain, UpdateResourcePayload } from '@haze/resource'
...
import { CurseforgeApiError, CurseforgeV1Client } from '@haze/curseforge'
