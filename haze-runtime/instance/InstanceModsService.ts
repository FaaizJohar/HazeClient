import { Resource, ResourceDomain, ResourceManager } from '@haze/resource'
import { InstanceModsService as IInstanceModsService, InstanceModsServiceKey, UpdateInstanceResourcesOptions } from '@haze/runtime-api'
