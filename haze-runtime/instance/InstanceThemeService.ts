import { InstanceThemeService as IInstanceThemeService, InstanceThemeServiceKey, MediaData, ThemeData } from '@haze/runtime-api'
...
export class InstanceThemeService extends AbstractService implements IInstanceThemeService {
  ...
  async copyMediaFromGlobal(instancePath: string, url: string): Promise<MediaData> {
    ...
    const sourcePath = this.getAppDataPath('theme-media', fileName)
