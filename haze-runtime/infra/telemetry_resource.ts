import { ResourceDomain, ResourceManager, type ResourceMetadata, type ResourceState, type UpdateResourcePayload } from '@haze/resource'
import { kResourceManager } from '~/resource'
import { getInstanceModStateKey, Settings } from '@haze/runtime-api'
