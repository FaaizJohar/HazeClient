import { CurseforgeV1Client, File, Mod, guessCurseforgeFileUrl } from '@haze/curseforge'
import { InstanceFile, McbbsModpackManifest, ModpackFileInfoCurseforge, getInstanceConfigFromMcbbsModpack } from '@haze/instance'
import { ResourceDomain } from '@haze/resource'
import { readEntry } from '@haze/unzip'
import { join } from 'path'
import { Entry } from '@haze/yauzl'
