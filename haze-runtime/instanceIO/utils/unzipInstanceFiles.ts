import { InstanceFile } from '@haze/instance'
import { Tracker, onProgress } from '@haze/installer'
import { openEntryReadStream } from '@haze/unzip'
import { WorkerQueue, isSystemError } from '@haze/utils'
import { createWriteStream } from 'fs'
import { ensureDir, stat } from 'fs-extra'
import { dirname } from 'path'
import { pipeline } from 'stream/promises'
import { Entry, ZipFile } from '@haze/yauzl'
import { ZipManager } from '~/infra'
import { InstallInstanceTrackerEvents } from '@haze/runtime-api'
