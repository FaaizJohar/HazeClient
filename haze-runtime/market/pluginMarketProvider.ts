...
} from '@haze/curseforge'
import { DownloadBaseOptions } from '@haze/file-transfer'
import { diagnoseFile, onDownloadSingle, Tracker } from '@haze/installer'
import { InstanceFile as _InstanceFile } from '@haze/instance'
import { ModrinthV2Client, ProjectVersion } from '@haze/modrinth'
import { File, isValidCurseforgeRef, isValidModrinthRef } from '@haze/resource'
import {
