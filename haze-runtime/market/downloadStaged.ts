import { DownloadOptions, download } from '@haze/file-transfer'
 ...
 *
 * Why this helper lives here (and NOT in @haze/file-transfer):
 ...
 * - Keeping the rename / cleanup logic out of @haze/file-transfer
