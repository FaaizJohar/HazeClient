import { checksum, LibraryInfo, MinecraftFolder, ResolvedLibrary, Version } from '@haze/core'
import { download, type DownloadBaseOptions } from '@haze/file-transfer'
import {
  AnyTracker,
  AssetsOptions,
...
import { waitProcess } from '@haze/installer/utils'
import {
  Task,
  DiagnoseOptions,
    ...
    for (const java of validJavaPaths) {
      try {
        ...
        if (err instanceof Error) {
          ...
          // download, AV stripping). `@haze/installer.installForge` opens it
