import { LibraryInfo, Version } from '@haze/core'
import { ElyByServiceKey, type ElyByService as IElyByService } from '@haze/runtime-api'
import { open, openEntryReadStream, walkEntriesGenerator } from '@haze/unzip'
...
export class ElyByService extends AbstractService implements IElyByService {
  ...
  async #init() {
    ...
    const resp = await this.app.fetch('https://api.haze.app/elyby/authlib', {
      headers: etag ? {
        'If-None-Match': etag,
      } : {},
    })
