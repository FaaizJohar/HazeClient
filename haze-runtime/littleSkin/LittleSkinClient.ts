import { AddClosetOptions, ClosetResponse, GetClosetOptions, ListSkinResult, LittleSkinCharacter, RenameClosetOptions, SetCharacterNameOptions, SetCharacterTextureOptions } from '@haze/runtime-api'
