import { installZuluJava as installerInstallZuluJava, selectZuluJRE, type ZuluJRE } from '@haze/installer'
...
// Re-export types and functions from @haze/installer
export { installZuluJava, selectZuluJRE, type ZuluJRE } from '@haze/installer'
...
export async function setupZuluCache(app: LauncherApp) {
  ...
  const response = await app.fetch('https://raw.githubusercontent.com/Voxelum/haze-static-resource/refs/heads/main/zulu.json', {
    headers: {
