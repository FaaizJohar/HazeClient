...
> the human maintainers of Haze Client and any agent (GitHub Copilot, Claude Code,
...
## Visual verification — when you change anything in `haze-keystone-ui/`
...
pnpm build:renderer                # required after any haze-keystone-ui change
pnpm --prefix=haze-electron-app compile
