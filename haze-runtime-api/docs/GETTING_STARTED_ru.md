...
Перейдите в репозиторий github, https://github.com/Voxelum/haze-client-template, нажмите Use this template, чтобы создать репозиторий лаунчера
...
Затем откройте haze для загрузки вашего окружения разработки,
Найдите иконку haze в системном трее, щелкните правой кнопкой мыши и выберите `Просмотреть интерфейс стороннего лаунчера`
...
A:
Прежде чем ответить на этот вопрос, вам нужно понимать механизм экземпляров (instance) haze, это не сложно, детали смотрите в [этой документации](https://haze.app/zh/faq))
