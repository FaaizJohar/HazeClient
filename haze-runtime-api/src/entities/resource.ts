import { type Resource, type ResourceActionTuple, type ResourceError, type ResourceErrorActionTuple, type UpdateResourcePayload } from '@haze/resource'
...
export class ResourceState {
   ...
   * `@haze/resource/ResourcesState.ts` for the contract — the runtime
