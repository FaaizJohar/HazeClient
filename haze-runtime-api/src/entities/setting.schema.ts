...
export const SettingSchema = z.object({
  ...
  globalMaxMemory: z.number().catch(4096),
  /** Global assign memory setting */
  globalAssignMemory: z.union([z.boolean(), z.literal('auto')]).catch(true),
  /** Global VM options */
  globalVmOptions: z.array(z.string()).catch(['-XX:+UseZGC', '-XX:+ZGenerational']),
