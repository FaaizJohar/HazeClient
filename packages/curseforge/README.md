...
[![npm version](https://img.shields.io/npm/v/@haze/curseforge.svg)](https://www.npmjs.com/package/@haze/curseforge)
[![Downloads](https://img.shields.io/npm/dm/@haze/curseforge.svg)](https://npmjs.com/@haze/curseforge)
[![Install size](https://packagephobia.now.sh/badge?p=@haze/curseforge)](https://packagephobia.now.sh/result?p=@haze/curseforge)
...
```ts
import { CurseforgeV1Client, SearchOptions } from '@haze/curseforge'
