...
[![npm version](https://img.shields.io/npm/v/@haze/modrinth.svg)](https://www.npmjs.com/package/@haze/modrinth)
[![Downloads](https://img.shields.io/npm/dm/@haze/modrinth.svg)](https://npmjs.com/@haze/modrinth)
[![Install size](https://packagephobia.now.sh/badge?p=@haze/modrinth)](https://packagephobia.now.sh/result?p=@haze/modrinth)
...
```ts
import { ModrinthV2Client, SearchResult } from '@haze/modrinth'
...
```ts
import { ModrinthV2Client, ProjectVersionFile, ProjectVersion } from '@haze/modrinth'
