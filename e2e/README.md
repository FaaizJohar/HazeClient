...
pnpm build:renderer && pnpm --prefix=haze-electron-app compile
...
3. Add `data-testid` attributes (not text/class selectors) for any new
   anchors in `haze-keystone-ui/` and surface them in
