import { NetworkErrorCode, NetworkException } from '@haze/runtime-api'
import { LauncherApp, Shell } from '@haze/runtime/app'
import { LAUNCHER_NAME } from '@haze/runtime/constant'
...
export default class ElectronLauncherApp extends LauncherApp {
  ...
  constructor() {
    ...
    // haze-runtime/app/LauncherApp.ts) to a per-test temporary directory.
