...
import { PartialRuntimeVersions, RuntimeVersions } from '@haze/instance';
  ...
  >
    ...
    <template #subtitle>
      <v-list-item-subtitle class="flex gap-1">
        <v-chip
          v-if="mounted && (runtime.minecraft)"
          variant="outlined"
          size="small"
          label
        >
        ...
        <v-chip
          v-if="mounted && (runtime.fabricLoader)"
          variant="outlined"
          size="small"
          label
        >
        ...
        <v-chip
          v-if="mounted && (runtime.neoForged)"
          variant="outlined"
          size="small"
          label
        >
        ...
        <v-chip
          v-if="mounted && (runtime.quiltLoader)"
          variant="outlined"
          size="small"
          label
        >
