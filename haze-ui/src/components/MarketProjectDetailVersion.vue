    ...
    >
      ...
      <div class="version-card__identity">
        <div class="version-card__title-row">
          ...
          <v-chip
            v-if="mounted && (version.installed)"
            size="x-small"
            label
            color="primary"
            variant="flat"
...
const loaders = computed(() => props.version.loaders.map(l => {
  if (l.toLowerCase() === 'vanilla') return { icon: 'haze:minecraft', loader: l }
  if (l.toLowerCase() === 'forge') return { icon: 'haze:forge', loader: l }
  if (l.toLowerCase() === 'fabric') return { icon: 'haze:fabric', loader: l }
  if (l.toLowerCase() === 'quilt') return { icon: 'haze:quilt', loader: l }
  if (l.toLowerCase() === 'neoforge') return { icon: 'haze:neoForged', loader: l }
  if (l.toLowerCase() === 'iris') return { icon: 'haze:iris', loader: l }
  if (l.toLowerCase() === 'optifine') return { icon: 'haze:optifine', loader: l }
  return { loader: l }
}))
