            ...
            <v-expansion-panel>
              <v-expansion-panel-title>
                <span class="flex items-center gap-2">
                  {{ t('dependencies.name') }}
                  <v-chip v-if="mounted" size="x-small" label variant="tonal" color="primary">
        ...
        <template v-if="curseforge || modrinth">
          ...
          <span v-else class="flex flex-wrap gap-2 px-2" v-roving-tabindex role="toolbar">
            ...
            <v-btn
              ...
              variant="text"
            >
              <v-icon class="mt-0.5" :size="30"> haze:curseforge </v-icon>
            </v-btn>
          </span>
...
const iconMapping = {
  ...
  fabric: 'haze:fabric',
  quilt: 'haze:quilt',
  optifine: 'haze:optifine',
  neoforge: 'haze:neoForged',
  iris: 'haze:iris',
  oculus: 'haze:oculus',
