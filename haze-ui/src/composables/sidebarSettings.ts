...
export function useSidebarSettings(): SidebarSettings {
  const position = useLocalStorageCacheStringValue('sidebar_position', 'top' as SidebarPosition)
  const style = useLocalStorageCacheStringValue('sidebar_style', 'notch' as SidebarStyle)
