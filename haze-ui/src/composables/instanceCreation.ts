...
import {  InstanceInstallServiceKey, InstanceServiceKey, VersionMetadataServiceKey } from '@haze/runtime-api'
import type { GameProfile } from '@haze/user'
import { InjectionKey, Ref, reactive } from 'vue'
import { kLatestMinecraftVersion } from './version'
import { CreateInstanceOptions, Instance, InstanceData, InstanceFile } from '@haze/instance'
