...
import { BaseServiceKey, Environment, Settings } from '@haze/runtime-api'
...
export function useSettings() {
  ...
  const gameActiveMode = inject('gameActiveMode', useLocalStorageCacheBool('gameActiveMode', true))
