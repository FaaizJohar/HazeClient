    ...
    <div class="flex h-full flex-col gap-2 overflow-auto" @dragover.prevent @drop="onDrop">
      <v-card class="z-5 flex-shrink flex-grow-0 rounded-none px-2 py-1 pb-2" variant="flat">
        <div class="flex items-center gap-2">
          ...
          <v-chip v-if="mounted && (groupState === 'connected')" size="small" label color="primary">
      ...
      >
        <template v-if="navigation === 'connections'">
          ...
          >
            ...
            <template #append>
              <v-chip v-if="mounted" label variant="outlined">
          ...
          <v-list-item class="flex-1 flex-grow-0">
            ...
            <v-list-item-subtitle>
              ...
              <v-chip v-if="mounted" label size="small" variant="outlined" @click="hideIp = !hideIp">
...
import { AUTHORITY_MICROSOFT, BaseServiceKey } from '@haze/runtime-api'
...
const onDrop = (e: DragEvent) => {
  const url = e.dataTransfer?.getData('haze/url')
  if (url) {
    handleUrl(url)
  }
}
