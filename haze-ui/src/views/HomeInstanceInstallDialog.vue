  ...
  >
    <div class="select-none flex max-h-[90vh] flex-col overflow-hidden">
      ...
      <div class="flex items-center px-6 pt-6 pb-4">
        ...
        <v-chip
          v-if="mounted && (!refreshing && upgrade)"
          size="small"
          variant="tonal"
          color="primary"
...
import type { EditInstanceOptions } from '@haze/instance'
import {
