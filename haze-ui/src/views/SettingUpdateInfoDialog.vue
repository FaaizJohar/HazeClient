<template>
  ...
  >
    ...
    <v-card
      ...
      style="width: 100%"
      to="https://github.com/FaaizJohar/HazeClient/releases"
      target="browser"
      push
    >
...
const openOfficialWebsite = () => {
  window.open('https://github.com/FaaizJohar/HazeClient', 'browser')
}
const openGithub = () => {
  window.open('https://github.com/FaaizJohar/HazeClient/releases', 'browser')
}
</script>
