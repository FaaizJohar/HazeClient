<template>
  <SettingCard>
    ...
    <SettingItemSwitcher
      ...
      icon="code"
    >
      <v-chip v-if="mounted && (developerMode)" size="x-small" color="warning" class="ml-2">{{ t('setting.devModeLabel') }}</v-chip>
    </SettingItemSwitcher>
    ...
    <v-divider class="my-3" />
    <SettingItemSwitcher
      v-model="gameActiveMode"
      title="Game Active Mode"
      description="Suspend background work and throttle IPC when the game is running."
      icon="sports_esports"
    />
