  ...
  >
    ...
    >
      ...
      <v-icon
        ...
        size="small"
      >
        {{ (pack.modrinth || pack.modrinthProjectId) ? 'haze:modrinth' : (pack.curseforge || pack.curseforgeProjectId) ? 'haze:curseforge' : '' }}
      </v-icon>
    </template>
  </MarketItem>
</template>
...
import { BaseServiceKey, InstanceResourcePacksServiceKey, isCompatible } from '@haze/runtime-api'
