...
Відвідайте [оффіційну сторінку](https://haze.app) щоб завантажити програму!
...
Для загального розробника, дивіться [Внесок](i18n/CONTRIBUTING.ua.md)

Для розробника локалізації i18n, будь ласка, перейдіть за посиланням [Початок роботи з локалізацією](https://docs.haze.app/en/guide/i18n)
