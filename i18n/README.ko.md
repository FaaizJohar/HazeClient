...
<p align="center">
  ...
  <a href="https://github.com/Voxelum/haze-client/blob/master/LICENSE">
    <img src="https://img.shields.io/npm/l/@haze/core.svg" alt="License">
  </a>
...
공식 사이트([https://haze.app](https://haze.app/ko))에서 앱을 다운로드할 수 있어요.
...
번역(i18n) 작업을 하려면 [현지화를 시작하기](https://haze.app/ko/guide/i18n)를 따라 진행해 주세요.
...
| :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy), haze은 서버리스 자바스크립트 앱에 Deno Deploy를 활용하고 있어요. 제공: [Deno](https://deno.com/) |
