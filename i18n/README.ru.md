...
Посетите [официальный сайт](https://haze.app) чтобы скачать программу !
...
Для разработчика локализации i18n, пожалуйста, перейдите по ссылке [Начало работы с локализацией](https://docs.haze.app/en/guide/i18n)
## ЛИЦЕНЗИЯ
