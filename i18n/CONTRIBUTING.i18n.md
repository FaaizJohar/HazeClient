...
```bash
git clone --recurse-submodules https://github.com/your-id/haze-client
```
...
Under the folder you cloned, e.g. `haze-client`, run command
...
- haze-keystone-ui/locales
- haze-electron-app/main/locales
