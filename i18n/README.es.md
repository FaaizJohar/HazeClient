<p align="center">
  <a href="https://haze.app" target="_blank">
    <img alt="Logo" width="100" src="https://github.com/Voxelum/haze-client/blob/master/haze-electron-app/icons/dark@256x256.png">
  </a>
</p>

<p align="center">
  <a href="https://github.com/Voxelum/haze-client">
    <img src="https://github.com/Voxelum/haze-client/workflows/Build/badge.svg" alt="Build">
  </a>
  <a href="https://github.com/Voxelum/haze-client/blob/master/LICENSE">
    <img src="https://img.shields.io/npm/l/@haze/core.svg" alt="Licencia">
  </a>
  ...
  <a href="https://kook.top/gqjSHh">
    <img src="https://img.shields.io/endpoint?url=https://api.haze.app/kook-badge" alt="Kook">
  </a>
  <a href="https://afdian.com/@ci010">
    <img src="https://img.shields.io/endpoint?url=https://api.haze.app/afdian-badge" alt="afdian">
  </a>
  <a href="https://patreon.com/haze">
...
![home](https://raw.githubusercontent.com/Voxelum/haze-page/master/.vitepress/theme/assets/home.png)

¡Visita el [sitio oficial](https://haze.app) para descargar la aplicación!
...
```bash
brew tap voxelum/haze
brew install --cask --no-quarantine voxelum/haze
```
...
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/haze-client)

Para desarrolladores en general, consulta [Cómo contribuir](./CONTRIBUTING.md)

Para desarrolladores de i18n y localización, por favor sigue la [Guía de inicio para la localización](https://docs.haze.app/en/guide/i18n)
...
| :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy), haze aprovecha su plataforma sin complicaciones para aplicaciones JavaScript sin servidor. Proporcionado por [Deno](https://deno.com/)   |
