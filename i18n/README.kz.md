...
Қолданбаны жүктеп алу үшін [ресми сайтқа](https://haze.app) кіріңіз!
...
i18n локализация әзірлеушісі үшін [Локализацияны бастау] (https://docs.haze.app/en/guide/i18n) бөлімін орындаңыз.
...
| :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy), haze серверсіз JavaScript қолданбалары үшін қиындықсыз платформасын пайдаланады. Берген [Deno](https://deno.com/)   |
