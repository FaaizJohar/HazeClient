...
<p align="center">
  ...
  <a href="https://github.com/Voxelum/haze-client/blob/master/LICENSE">
    <img src="https://img.shields.io/npm/l/@haze/core.svg" alt="Licenc">
  </a>
...
Látogasd meg a [hivatalos honlapot](https://haze.app) az alkalmazás letöltéséhez!
...
i18n lokalizációs fejlesztőknek kérjük kövessétek az [Első lépések a lokalizációban](https://docs.haze.app/en/guide/i18n) útmutatót
...
| :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy), haze a problémamentes platformját használja serverless JavaScript alkalmazásokhoz. A [Deno](https://deno.com/) biztosítja   |
